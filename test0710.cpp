...
void printBands(const vector<Band>& bands) {
    for (const auto& band : bands) {
        ...
        cout << ", Extended: [" << band.extended.min << ", " << band.extended.max << "]" << endl;
    }
}
...
int main() {
    ...
    sort(left.begin(), left.end(), [](const CoveredRange& a, const CoveredRange& b) {
        return a.range.min < b.range.min;
    });
    sort(right.begin(), right.end(), [](const CoveredRange& a, const CoveredRange& b) {
        return a.range.min < b.range.min;
    });
